...
if(!empty($newCommentText)&& !empty($_SESSION['name']) && $_SESSION['ban']==false){
    ...
    echo '<script style="text/javascript">alert("Нету прав(Ваш аккаунт заблокированый)"</script>';
} elseif(empty($_SESSION['name'])){
    echo '<script style="text/javascript">alert("Нужно авторизироваться"</script>';
}
