...
<div class="str">
	      ...
	      <form action="registration.php" method="post">
	        ...
	        <section>
	          <input type="submit" value="Дальше!" name="Go" style="margin-left:5%;">
			  ...
			  <?php
					...
					fclose($handle);
					echo "<h3>Ви зарегистрированы! Для того, чтобы войти в систему, вернитесь на предыдущую страницу(нажав на вкладку Вопрос-Ответ).</h3>";}
	?>
